    ...
    <Row>
      <Col span={12}>
        ...
        >
          ...
          <Radio.Group defaultValue={'touching'} style={{width: 500}}>
            <Form.Item style={{ margin: '10px 0'}}>
              <Space style={{ display: 'flex', justifyContent: 'space-between' }}>
                <Radio value={'touching'} onChange={handleOptionChange}>Число качаний</Radio>
                <Input addonAfter="кач/мин" disabled={selectedOption !== 'touching'} style={{ width: 200 }} />
              </Space>
            </Form.Item>
            <Form.Item style={{ margin: '10px 0' }}>
              <Space style={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          {sourceData.map((formItem: SourceDataType) => (
            formItem.type === 'select'
              ? <Form.Item label={formItem.label} labelAlign="left" style={{ margin: '10px 0' }}>
        ...
        <Form labelCol={{ span: 16 }} style={{ width: 500 }}>
          ...
          {results.length
            ? results.map((result: ResultType) => (
              <Form.Item label={result.label} labelAlign="left" style={{ margin: '5px' }}>
